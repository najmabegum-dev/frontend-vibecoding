/**
 * Icon set — sourced 1:1 from the provided asset_package SVG pack.
 * All paths/viewBoxes are untouched; only fill/stroke were swapped to
 * currentColor so each icon inherits text color via className.
 *
 * Usage: <ChevronDown className="w-5 h-5 text-forsythia" />
 */
...
export function CogEightTooth(props) {
  return (
    <svg {...base(props)} fill="currentColor">
      <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function CubeSolid(props) {
  return (
